...
namespace Lessons.Topic1.Lessons
{
    public class Lesson1 : BaseModel
    {
        ...
        {
            TopicId = 1;
            TaskTitle = "Вывести на консоль, какую среду разработки Вы выбрали для прохождения обучения";
            TaskText = "Создать файл с нужным расширением, написать код для вывода на экран.";
        }
